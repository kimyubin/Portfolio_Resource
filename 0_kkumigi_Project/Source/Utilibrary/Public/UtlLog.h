...
/** 시간 확인용 */
#define UT_TIME_CHECK_BEGIN() int64 _UtlTimeChecker_ = FUtlTime::GetNowMicroSec();
#define UT_TIME_CHECK() UT_LOG("%lld, %s", FUtlTime::GetNowMicroSec() - _UtlTimeChecker_, *GetName()); _UtlTimeChecker_ = FUtlTime::GetNowMicroSec();
