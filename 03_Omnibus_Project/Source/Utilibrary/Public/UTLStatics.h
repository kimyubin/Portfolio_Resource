 ...
 * @note 에디터 전용.
 */
UTILIBRARY_API ATextRenderActor* SimpleTextRender(const FVector& InLocation, const float InLifeSpan, const FString& InText, const float InWorldSize, const double InZOffset = 10.0f, const FColor& InRenderColor = FColor::Red);
